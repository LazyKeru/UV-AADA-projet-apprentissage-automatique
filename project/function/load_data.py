...
def load_data(path):
    """
    loads a dataset of matlab files, with the following naming convention : idAction_idSubject_idExperiment
    it tranforms the dataset into a DataFrame.
    :param str path: path to the folder containing all the matlab files
